...
// si esta en modo de pruebas (checkout dinamico con tarjeta, credenciales
// TEST-) o produccion (link de pago por pedido y, si se activa, tarjeta con
// credenciales APP_USR-) sin requerir sesion de admin. mpPublicKey va aquí
// (no como NEXT_PUBLIC_*) porque cuál de las dos usar depende del modo
